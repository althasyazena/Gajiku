...
class SalaryController extends Controller
{
    ...
    public function store(SalaryRequest $request) {
        ...
        return redirect()->route('karyawan.index')->with('success', 'Slip gaji berhasil ditambahkan');
    }
    ...
    public function download($id) {
        ...
        // setting nama pdf yang bisa di download
    ...
    public function delete($id) {
        ...
        return redirect()->route('karyawan.index')->with('success', 'Slip gaji berhasil dihapus');
    }
}
