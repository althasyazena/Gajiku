                    ...
                    <div class="mb-6 flex items-center justify-between mx-6 pt-6">
                        <div>
                            <div class="flex items-center gap-2.5 mb-1">
                                ...
                                <h1 class="text-4xl font-bold text-tertiary">Update <span class="text-secondary bg-accent py-1 px-2 rounded-lg">Data</span> Karyawan</h1>
                            </div>
                            <p class="text-gray-500 ml-3.5 mt-2">Perbarui informasi karyawan di bawah ini</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mx-6">
                        ...
                        <form action="{{ route('karyawan.update', $employee) }}" method="POST" class="space-y-6">
                            ...
                            <div class="pt-2 flex gap-3">
                                <button
                                    type="submit"
                                    class="px-6 py-2 bg-accent text-secondary text-sm font-medium rounded-xl hover:bg-tertiary transition">
                                    Update Data
                                </button>
