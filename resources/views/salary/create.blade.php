                    ...
                    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                {{-- Hanya Sebagai UI --}}
                                <input type="text" value="{{ $employee->name }} ({{ $employee->position }})" disabled class="w-full text-sm border border-gray-200 rounded-lg px-3 py-2.5 text-gray-700 bg-gray-50 cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
                                @error('employee_id')
                    ...
                    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6 mt-4">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input value="{{ $employee->salary }}" disabled type="number" class="w-full text-sm border border-gray-200 rounded-lg pl-9 pr-4 py-2.5 text-gray-700 bg-gray-50 cursor-not-allowed focus:outline-none" />
                                @error('gaji_pokok')
